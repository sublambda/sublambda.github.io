...
// Link info: (409004 (js ((compactness 9))) "_test" (("_test")) (module_register entrypt_init returnpt_init ctrlpt_init parententrypt_init cons flonumbox inttemp1 inttemp2 flonump jsnumberp cpxnum stringp continuation_capture4 continuation_capture1 absent_obj r3 peps string base92_decode r2 pairp r4 build_rest closure_alloc poll r1 r0 sp stack make_interned_symbol glo wrong_nargs nargs) (##make-parameter _test#nb-skipped-tests _test#test-verbose? ##with-exception-handler _test#nb-failed-tests ##exit ##error ##call-with-output-string ##parameterize1 ##exit-with-err-code-no-cleanup ##repl-output-port _test#nb-passed-tests _test#test-all? _test#redirect-test-output-port _test#test-quiet? _test#context ##continuation-creator display-exception-in-context) (_test#nb-skipped-tests _test#test-verbose? _test#nb-failed-tests ##exit _test#nb-passed-tests _test#test-all? _test#redirect-test-output-port _test#test-quiet? _test#context) (_test#nb-skipped-tests _test#test-verbose? _test#nb-failed-tests ##exit _test#nb-passed-tests _test#test-all? _test#redirect-test-output-port _test#test-quiet? _test#context) #f)
