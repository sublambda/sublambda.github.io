...
// Link info: (409004 (js ((compactness 9))) "srfi/28" (("srfi/28")) (module_register returnpt_init ctrlpt_init parententrypt_init peps string base92_decode make_interned_char r4 make_interned_symbol glo r3 poll sp stack stringp build_rest r2 r0 r1 wrong_nargs nargs) (##write-substring ##get-output-string ##error ##fail-check-string ##open-output-string) () () #f)
