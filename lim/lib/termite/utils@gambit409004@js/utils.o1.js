...
// Link info: (409004 (js ((compactness 9))) "termite/utils" (("termite/utils")) (module_register entrypt_init returnpt_init ctrlpt_init parententrypt_init symbol pairp jsnumberp peps make_interned_char r2 r3 check_procedure r4 closure_alloc r1 make_interned_symbol glo check_procedure_glo poll r0 sp stack wrong_nargs nargs) (random-source-make-integers termite/utils#unquoted-symbol? ##eq? ##symbol? ##cdr ##string ##string->symbol termite/utils#make-uuid ##cadr random-source-randomize! ##extract-bit-field make-random-source termite/utils#quoted-symbol? ##vector-ref termite/utils#random-integer-65536 ##car ##bitwise-ior ##pair?) (termite/utils#unquoted-symbol? termite/utils#make-uuid termite/utils#quoted-symbol? termite/utils#random-integer-65536) (termite/utils#unquoted-symbol? termite/utils#make-uuid termite/utils#quoted-symbol? termite/utils#random-integer-65536) #f)
