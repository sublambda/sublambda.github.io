...
// Link info: (409004 (js ((compactness 9))) "_git" (("_git")) (module_register entrypt_init returnpt_init ctrlpt_init parententrypt_init eof_obj closure_alloc jsnumberp peps pairp r4 absent_obj cons make_interned_keyword structure string base92_decode make_interned_symbol glo r2 r3 poll sp stack stringp r0 r1 wrong_nargs nargs) (_tar#tar-unpack-port ##fail-check-procedure ##read-line ##file-exists? ##fail-check-string-list ##process-status ##path-expand _git#d ##write-string ##file-info-type ##call-with-input-process ##fail-check-string ##file-info ##repl ##os-environ ##tty-mode-reset) () () #f)
