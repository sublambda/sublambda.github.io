...
// Link info: (409007 (js ((compactness 9))) "_test" (("_test")) (module_register entrypt_init returnpt_init ctrlpt_init parententrypt_init cons flonumbox flonump inttemp1 inttemp2 jsnumberp cpxnum stringp continuation_capture4 continuation_capture1 absent_obj r3 peps string base92_decode r2 pairp r4 build_rest closure_alloc poll r1 r0 sp stack make_interned_symbol glo wrong_nargs nargs) (_test#nb-passed-tests _test#test-verbose? _test#test-all? ##exit-with-err-code-no-cleanup ##error ##call-with-output-string _test#context ##continuation-creator _test#test-quiet? display-exception-in-context ##repl-output-port _test#redirect-test-output-port _test#nb-failed-tests ##make-parameter ##exit _test#nb-skipped-tests ##with-exception-handler _test#call-thunk ##parameterize1) (_test#%test-begin _test#nb-passed-tests _test#test-verbose? _test# _test#test-all? _test#call-thunk-set! _test#test-quiet?-set! _test#%test-approximate _test#absent _test#test-indent _test#%test-predicate _test#failed-test _test#test-verbose?-set! _test#context _test#test-quiet? _test#%test-relation _test#test-msg _test#test-output-port _test#redirect-test-output-port _test#test-all?-set! _test#passed-test _test#nb-failed-tests _test#%test-error ##exit _test#nb-skipped-tests _test#%test-end _test#%test-group _test#call-thunk) (_test#nb-passed-tests _test#test-verbose? _test#test-all? _test#context _test#test-quiet? _test#redirect-test-output-port _test#nb-failed-tests ##exit _test#nb-skipped-tests _test#call-thunk) #f)
...
_cst10____test = _i("_test#call-thunk");

_cst11____test = _i("##exit-with-err-code-no-cleanup");

_cst12____test = new _ScmString(_z("MMMC"));

_cst13____test = _i("##display");

_cst14____test = _i("##repl-output-port");

_cst15____test = new _ScmString(_z("cDcOcOCcWcHcVcWcVCcScDcVcVcHcG"));

_cst16____test = new _ScmString(_z("CcWcHcVcW"));

_cst17____test = new _ScmString(_z("CcIcDcLcOcHcG"));

_cst18____test = new _ScmString(_z("CcRcXcWCcRcICcDCcWcRcWcDcOCcRcIC"));

_cst19____test = new _ScmString(_z("CcDcIcWcHcUC"));

_cst20____test = new _ScmString(_z("cV"));

_cst21____test = new _ScmString(_z("CcWcHcVcW"));

_cst22____test = new _ScmString(_z("CcHc[cHcFcXcWcHcGCcWcHcVcW"));

_cst23____test = new _ScmString(_z("-"));

_cst24____test = new _ScmString(_z("CcDcQcGC"));

_cst25____test = new _ScmString(_z("CcVcNcLcScScHcGCcWcHcVcW"));

_cst26____test = new _ScmString(_z(""));

_cst27____test = _i("##call-with-output-string");

_cst28____test = _i("##newline1");

_cst29____test = new _ScmString(_z(""));

_cst30____test = new _ScmString(_z("Cc*c2c7C"));

_cst31____test = _i("##write");

_cst32____test = _i("display-exception-in-context");

_cst33____test = _i("##with-exception-handler");

_cst34____test = new _ScmString(_z(""));

_cst35____test = _i("##continuation-graft");

_cst36____test = new _ScmString(_z("c3c$c6c6c(c'C"));

_cst37____test = new _ScmString(_z("c)c$c,c/c(c'C"));

_cst38____test = _i("##string-append");

_cst39____test = new _ScmString(_z(""));

_cst40____test = new _ScmString(_z("c3c$c6c6c(c'C"));

_cst41____test = new _ScmString(_z("c)c$c,c/c(c'C"));

_cst42____test = new _ScmString(_z(""));

_cst43____test = _i("##number?");

_cst44____test = new _ScmString(_z("c3c$c6c6c(c'C"));

_cst45____test = new _ScmString(_z("c)c$c,c/c(c'C"));

_cst46____test = _i("##real-part");

_cst47____test = _i("##imag-part");

_cst48____test = _i("##continuation-creator");

_cst49____test = new _ScmString(_z(""));

_cst50____test = new _ScmString(_z("c3c$c6c6c(c'C"));

_cst51____test = new _ScmString(_z("c)c$c,c/c(c'C"));

_cst52____test = _i("nontail-exception-raised-in");

_cst53____test = new _ScmString(_z("-"));

_cst54____test = new _ScmString(_z("cWcHcVcWcLcQcJC"));

_cst55____test = new _ScmString(_z("cWcHcVcWPcHcQcGCcZcLcWcKcRcXcWCcPcDcWcFcKcLcQcJCcWcHcVcWPcEcHcJcLcQ"));

_cst56____test = _i("##equal?");

_cst57____test = _i("##error");

_cst58____test = new _ScmString(_z("cWcHcVcWPcHcQcGCcZcLcWcKCcXcQcPcDcWcFcKcHcGCcVcXcLcWcHPcQcDcPcHOCcVcKcRcXcOcGCcEcH"));

_cst59____test = _i("##length");

_cst60____test = _i("##iota");

_cst61____test = _i("##string-concatenate");

_cst62____test = new _ScmString(_z("c_C"));

_cst63____test = new _ScmString(_z(""));

_cst64____test = _i("##parameterize1");
...
_s[_t+2] = closure0;
_g["##exit"] = _s[_t+2];
_g["_test#call-thunk"] = _bb1___test_23_call_2d_thunk;
_a = void 0;
--_t;
return _s[_t+1]();
},1,1);
...
return _bb13___test_23_passed_2d_test();
}
},-1,_i("_test#passed-test"),!1,!0);

_j(_bb2___test_23_passed_2d_test = () => {
_s[_t+1] = _r;
var closure0 = _closure_alloc([_bb10___test_23_passed_2d_test,_a]);
_s[_t+2] = closure0;
_b = _s[_t+2];
_a = _cst26____test;
_t += 2;
return _p(_bb3___test_23_passed_2d_test);
});
...
_l(_bb10___test_23_passed_2d_test = () => {
if (_n !== 1) {
return _w(_d);
}
_s[_t+1] = _r;
...
_b = _a;
_a = _d(!0)[1];
_r = _bb11___test_23_passed_2d_test;
_n = 2;
_t += 2;
return _e["##display"]();
},1);
...
_r = _bb4___test_23_passed_2d_test;
_n = 2;
--_t;
return _g["##call-with-output-string"]();
});

_k(_bb11___test_23_passed_2d_test = () => {
_a = _s[_t];
_r = _s[_t-1];
return _p(_bb12___test_23_passed_2d_test);
},2,1);

_k(_bb4___test_23_passed_2d_test = () => {
_s[_t+1] = _a;
...
_j(_bb12___test_23_passed_2d_test = () => {
_n = 1;
_t -= 2;
return _e["##newline1"]();
});
...
if (!(_a === !1)) {
return _bb7___test_23_passed_2d_test();
} else {
return _bb9___test_23_passed_2d_test();
}
},2,1);

_j(_bb7___test_23_passed_2d_test = () => {
_b = _a;
_r = _s[_t-1];
_a = _s[_t];
return _p(_bb8___test_23_passed_2d_test);
});
...
_m(_bb1___test_23_call_2d_thunk_2d_set_21_ = () => {
if (_n !== 1) {
return _w(_bb1___test_23_call_2d_thunk_2d_set_21_);
}
_g["_test#call-thunk"] = _a;
_a = void 0;
return _r;
},-1,_i("_test#call-thunk-set!"),!1,!0);
...
_s[_t+3] = _a;
_s[_t+4] = _d;
var closure2 = _closure_alloc([_bb79___test_23__25_test_2d_approximate,_s[_t+1],_a]);
_s[_t+5] = closure2;
_a = _s[_t+5];
_b = _d(!0)[2];
_t += 5;
...
_l(_bb79___test_23__25_test_2d_approximate = () => {
if (_n !== 1) {
return _w(_d);
}
_s[_t+1] = _bb81___test_23__25_test_2d_approximate;
_c = _a;
_b = _d(!0)[1];
_a = _d(!0)[2];
++_t;
return _p(_bb80___test_23__25_test_2d_approximate);
},2);
...
_l(_bb81___test_23__25_test_2d_approximate = () => {
if (_n !== 4) {
return _w(_bb81___test_23__25_test_2d_approximate);
}
_s[_t+1] = _s[_t];
_s[_t] = _a;
_s[_t+2] = _c;
...
_a = _s[_t+1];
_t += 2;
return _p(_bb82___test_23__25_test_2d_approximate);
},-1);
...
_s[_t+1] = _a;
var closure3 = _closure_alloc([_bb79___test_23__25_test_2d_approximate,_s[_t-3],_s[_t-1]]);
_s[_t+2] = closure3;
_a = _s[_t+2];
_b = _s[_t](!0)[4];
...
return _bb77___test_23__25_test_2d_approximate();
}
});
...
_j(_bb77___test_23__25_test_2d_approximate = () => {
_a = _s[_t];
...
_a = _s[_t-3];
_r = _bb76___test_23__25_test_2d_approximate;
_n = 1;
return _e["##real-part"]();
});
...
_k(_bb76___test_23__25_test_2d_approximate = () => {
return _bb35___test_23__25_test_2d_approximate();
},6,2);
...
return _bb74___test_23__25_test_2d_approximate();
}
},5,2);
...
if (_f(_c) && _f(_a)) {
return _bb65___test_23__25_test_2d_approximate();
} else {
return _bb63___test_23__25_test_2d_approximate();
}
});
...
_j(_bb74___test_23__25_test_2d_approximate = () => {
--_t;
return _bb10___test_23__25_test_2d_approximate();
});
...
_b = _a;
_a = _c;
_r = _bb54___test_23__25_test_2d_approximate;
_n = 2;
_t += 4;
return _e["##-"]();
});

_j(_bb65___test_23__25_test_2d_approximate = () => {
_d = _F(_c.a - _a.a);
if (_y(_b) && _y(_d)) {
return _bb39___test_23__25_test_2d_approximate();
} else {
...
_a = _s[_t];
_r = _bb69___test_23__25_test_2d_approximate;
_n = 1;
--_t;
return _e["##imag-part"]();
});
...
return _bb57___test_23__25_test_2d_approximate();
}
});

_k(_bb54___test_23__25_test_2d_approximate = () => {
_d = _a;
_c = _s[_t];
_b = _s[_t-1];
_a = _s[_t-2];
...
++_t;
return _bb72___test_23__25_test_2d_approximate();
}
});

_k(_bb69___test_23__25_test_2d_approximate = () => {
return _bb70___test_23__25_test_2d_approximate();
},4,2);
...
_j(_bb57___test_23__25_test_2d_approximate = () => {
_s[_t+1] = _r;
_s[_t+2] = _a;
_s[_t+3] = _b;
_s[_t+4] = _c;
_b = _d;
_a = _s[_t+3];
_r = _bb58___test_23__25_test_2d_approximate;
_n = 2;
_t += 4;
return _e["##>="]();
});
...
_a = _s[_t-2].b;
return _bb60___test_23__25_test_2d_approximate();
});

_j(_bb72___test_23__25_test_2d_approximate = () => {
_a = _s[_t-2];
_r = _bb59___test_23__25_test_2d_approximate;
_n = 1;
return _e["##imag-part"]();
});
...
_k(_bb58___test_23__25_test_2d_approximate = () => {
_d = _a;
_c = _s[_t];
_b = _s[_t-1];
_a = _s[_t-2];
...
_j(_bb60___test_23__25_test_2d_approximate = () => {
_c = _a;
_a = _s[_t-1](!0)[1];
_b = _s[_t];
_r = _bb64___test_23__25_test_2d_approximate;
--_t;
return _bb61___test_23__25_test_2d_approximate();
});

_k(_bb59___test_23__25_test_2d_approximate = () => {
return _bb60___test_23__25_test_2d_approximate();
},5,2);
...
return _bb51___test_23__25_test_2d_approximate();
}
});
...
_k(_bb64___test_23__25_test_2d_approximate = () => {
return _bb10___test_23__25_test_2d_approximate();
},4,2);
...
_b = _s[_t];
_a = _c;
_r = _bb48___test_23__25_test_2d_approximate;
_n = 2;
_t += 2;
return _e["##+"]();
});
...
_k(_bb48___test_23__25_test_2d_approximate = () => {
_b = _s[_t];
_r = _s[_t-1];
if (_y(_b) && _y(_a)) {
_t -= 2;
...
_b = _a;
_a = _s[_t];
return _p(_bb46___test_23__25_test_2d_approximate);
});
...
_a = _X(_cst52____test,_X(_a,null));
_s[_t+1] = _a;
_a = _s[_t](!0)[5];
if (!(_a === !1)) {
++_t;
