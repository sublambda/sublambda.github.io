...
// Link info: (409005 (js ((compactness 9))) "_base64" (("_base64")) (module_register returnpt_init ctrlpt_init parententrypt_init stringp make_u8vector string base92_decode char bignum jsnumberp u8vector make_interned_symbol glo make_string poll cons box make_interned_char r4 stack sp r2 r3 absent_obj r0 r1 wrong_nargs nargs) (##fifo->string ##fail-check-char ##error ##fail-check-exact-integer ##fifo->u8vector ##fail-check-string ##fail-check-u8vector ##raise-range-exception) (##u8vector->base64 u8vector->base64 ##base64->u8vector base64->u8vector _base64#) () #f)

_cst0____base64 = _make_interned_char(43);

_cst1____base64 = _make_interned_char(47);

_cst2____base64 = _make_interned_char(61);

_cst3____base64 = _i("##fifo->string");

_cst4____base64 = _make_interned_char(10);
...
_s[_t] = new _Box(void 0);
_s[_t+1] = new _Box(void 0);
_s[_t+2] = new _Box(void 0);
_s[_t].a = _cst2____base64;
_s[_t+1].a = 64;
_s[_t+3] = _X(null,null);
_s[_t+3].a = _s[_t+3];
_s[_t+3] = [0,_s[_t+3]];
_s[_t+2].a = _s[_t+3];
_s[_t+3] = _s[_t];
...
_d = _s[_t-6].a[_b];
_s[_t+1] = _b + 1;
_s[_t+1] = _s[_t-6].a[_s[_t+1]];
_s[_t+2] = _b + 2;
_s[_t+2] = _s[_t-6].a[_s[_t+2]];
_s[_t+3] = _d >> 2;
_s[_t+4] = _s[_t+1] >> 4;
_d = _d << 4;
_d = _d + _s[_t+4];
...
_s[_t] = _s[_t-1].a;
_s[_t] = _make_string(_s[_t],0);
_s[_t+1] = _X(_s[_t],null);
_s[_t+2] = _d.a;
_s[_t+2].b = _s[_t+1];
_d.a = _s[_t+1];
_d = _s[_t];
...
_s[_t-4] = _s[_t].a;
_s[_t-4] = _make_string(_s[_t-4],0);
_s[_t-3] = _X(_s[_t-4],null);
_s[_t-2] = _d.a;
_s[_t-2].b = _s[_t-3];
_d.a = _s[_t-3];
_d = _s[_t-4];
...
return _bb89__23__23_base64_2d__3e_u8vector();
}
});
...
return _bb90__23__23_base64_2d__3e_u8vector();
}
});

_j(_bb89__23__23_base64_2d__3e_u8vector = () => {
if (_b === _absent_obj) {
return _bb5__23__23_base64_2d__3e_u8vector();
} else {
return _bb90__23__23_base64_2d__3e_u8vector();
...
_j(_bb90__23__23_base64_2d__3e_u8vector = () => {
if (_c === _absent_obj) {
return _bb6__23__23_base64_2d__3e_u8vector();
} else {
return _bb7__23__23_base64_2d__3e_u8vector();
...
_b = _s[_t-2];
_a = _s[_t-3];
_r = _bb82__23__23_base64_2d__3e_u8vector;
_t += 5;
return _p(_bb22__23__23_base64_2d__3e_u8vector);
});
...
_k(_bb82__23__23_base64_2d__3e_u8vector = () => {
if (!(_a === !1)) {
return _bb83__23__23_base64_2d__3e_u8vector();
} else {
return _bb84__23__23_base64_2d__3e_u8vector();
}
},11,7);
...
_j(_bb83__23__23_base64_2d__3e_u8vector = () => {
_s[_t] = _s[_t-4];
_s[_t-4] = _s[_t-3];
_c = _s[_t-1] + 1;
_b = _a;
...
_r = _s[_t];
_t -= 4;
return _p(_bb20__23__23_base64_2d__3e_u8vector);
});

_j(_bb84__23__23_base64_2d__3e_u8vector = () => {
_a = _s[_t-3].a;
if (!(_a === !1)) {
return _bb86__23__23_base64_2d__3e_u8vector();
} else {
return _bb85__23__23_base64_2d__3e_u8vector();
}
});
...
return _bb21__23__23_base64_2d__3e_u8vector();
}
});

_j(_bb86__23__23_base64_2d__3e_u8vector = () => {
_a = _cst33____base64;
_r = _s[_t-4];
return _p(_bb87__23__23_base64_2d__3e_u8vector);
});

_j(_bb85__23__23_base64_2d__3e_u8vector = () => {
_a = _s[_t-2].a;
if (_s[_t].a === _a.a) {
return _bb86__23__23_base64_2d__3e_u8vector();
} else {
return _bb88__23__23_base64_2d__3e_u8vector();
}
});
...
_a = _cst33____base64;
return _p(_bb81__23__23_base64_2d__3e_u8vector);
});

_j(_bb21__23__23_base64_2d__3e_u8vector = () => {
_d = _make_interned_char(_s[_t-6].a[_c]);
_s[_t+1] = _r;
_s[_t+2] = _a;
_s[_t+3] = _b;
_s[_t+4] = _c;
...
_j(_bb87__23__23_base64_2d__3e_u8vector = () => {
_n = 1;
_t -= 11;
return _g["##error"]();
});

_j(_bb88__23__23_base64_2d__3e_u8vector = () => {
_c = _s[_t-1] + 1;
_b = _s[_t-2];
_a = _s[_t-3];
_r = _s[_t-4];
...
if (!(_a === !1)) {
return _bb36__23__23_base64_2d__3e_u8vector();
} else {
...
_j(_bb36__23__23_base64_2d__3e_u8vector = () => {
_s[_t] = _s[_t-4];
_s[_t-4] = _s[_t-3];
_c = _s[_t-1] + 1;
_b = _a;
...
return _bb44__23__23_base64_2d__3e_u8vector();
}
});
...
return _bb19__23__23_base64_2d__3e_u8vector();
}
});

_j(_bb42__23__23_base64_2d__3e_u8vector = () => {
_a = _cst33____base64;
return _p(_bb43__23__23_base64_2d__3e_u8vector);
});

_j(_bb44__23__23_base64_2d__3e_u8vector = () => {
_d = _make_interned_char(_s[_t-7].a[_c]);
_s[_t+1] = _r;
_s[_t+2] = _a;
_s[_t+3] = _b;
_s[_t+4] = _c;
...
_b = _s[_t-4];
_a = _s[_t-5];
_r = _bb37__23__23_base64_2d__3e_u8vector;
_t += 5;
return _p(_bb22__23__23_base64_2d__3e_u8vector);
});
...
_k(_bb37__23__23_base64_2d__3e_u8vector = () => {
if (!(_a === !1)) {
...
_r = _s[_t];
_t -= 4;
return _p(_bb50__23__23_base64_2d__3e_u8vector);
});

_j(_bb38__23__23_base64_2d__3e_u8vector = () => {
_a = _s[_t-5].a;
if (_s[_t].a === _a.a) {
return _bb72__23__23_base64_2d__3e_u8vector();
} else {
return _bb39__23__23_base64_2d__3e_u8vector();
}
});
...
return _bb74__23__23_base64_2d__3e_u8vector();
}
});
...
_a = _cst33____base64;
return _p(_bb52__23__23_base64_2d__3e_u8vector);
});

_j(_bb53__23__23_base64_2d__3e_u8vector = () => {
_d = _make_interned_char(_s[_t-8].a[_c]);
_s[_t+1] = _r;
_s[_t+2] = _a;
_s[_t+3] = _b;
_s[_t+4] = _c;
...
_b = _s[_t-5];
_a = _s[_t-6];
_r = _bb46__23__23_base64_2d__3e_u8vector;
_t += 5;
return _p(_bb22__23__23_base64_2d__3e_u8vector);
});
...
_s[_t-12].b = _r;
_c.a = _r;
return _bb75__23__23_base64_2d__3e_u8vector();
});
...
_a = _cst33____base64;
_r = _s[_t-4];
return _p(_bb77__23__23_base64_2d__3e_u8vector);
});
...
_k(_bb46__23__23_base64_2d__3e_u8vector = () => {
if (!(_a === !1)) {
return _bb54__23__23_base64_2d__3e_u8vector();
} else {
return _bb47__23__23_base64_2d__3e_u8vector();
}
},14,10);

_j(_bb75__23__23_base64_2d__3e_u8vector = () => {
_d.a[_b] = _a;
_b = _s[_t-7];
_a = _s[_t-8];
_r = _s[_t-4];
...
_b = _s[_t-3];
_a = _s[_t-5];
_r = _bb66__23__23_base64_2d__3e_u8vector;
_t += 2;
...
_b = _s[_t];
_a = _s[_t-1];
_r = _bb61__23__23_base64_2d__3e_u8vector;
_t += 3;
return _p(_bb57__23__23_base64_2d__3e_u8vector);
});

_k(_bb66__23__23_base64_2d__3e_u8vector = () => {
_a = _s[_t-2] << 6;
_a = _a + _s[_t];
_a = 255 & _a;
_b = _s[_t-9].a;
...
_b = _s[_t-13];
_a = _s[_t-5];
_r = _bb65__23__23_base64_2d__3e_u8vector;
_t -= 2;
return _bb56__23__23_base64_2d__3e_u8vector();
});
...
return _bb49__23__23_base64_2d__3e_u8vector();
}
});
...
if (_d === 0) {
_t += 2;
return _bb58__23__23_base64_2d__3e_u8vector();
} else {
_t += 2;
...
_k(_bb61__23__23_base64_2d__3e_u8vector = () => {
_a = _s[_t] >> 2;
_b = _s[_t-1] << 4;
_a = _b + _a;
_a = 255 & _a;
...
_b = _b & _d;
if (_b === 0) {
return _bb62__23__23_base64_2d__3e_u8vector();
} else {
return _bb63__23__23_base64_2d__3e_u8vector();
}
},5,3);
...
_k(_bb65__23__23_base64_2d__3e_u8vector = () => {
_b = _s[_t-4];
_a = _s[_t-5];
_r = _s[_t];
_t -= 10;
...
_a = _cst33____base64;
_r = _s[_t-4];
return _p(_bb71__23__23_base64_2d__3e_u8vector);
});
...
_j(_bb58__23__23_base64_2d__3e_u8vector = () => {
_b = _b.a;
_b = _make_u8vector(_b,0);
_s[_t-1] = _X(_b,null);
_s[_t] = _a.a;
_s[_t].b = _s[_t-1];
_a.a = _s[_t-1];
...
_j(_bb62__23__23_base64_2d__3e_u8vector = () => {
_d = _s[_t-3].a;
_d = _make_u8vector(_d,0);
_r = _X(_d,null);
_s[_t-4] = _c.a;
...
_j(_bb63__23__23_base64_2d__3e_u8vector = () => {
_c = _c.a;
_c = _c.a;
_d = _c;
return _bb64__23__23_base64_2d__3e_u8vector();
