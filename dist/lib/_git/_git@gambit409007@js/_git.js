...
_cst34____git = _i("##reverse");

_cst35____git = _i("##fail-check-string-list");

_cst36____git = _i("##fail-check-procedure");

_cst37____git = new _ScmString(_z("cDcUcFcKcLcYcH"));

_cst38____git = _i("##process-status");

_cst39____git = _i("_tar#tar-unpack-port");

_cst40____git = _i("##repl");

_cst41____git = new _ScmString(_z("cFcOcRcQcH"));

_cst42____git = _i("##newline1");

_cst43____git = _i("##read-line");

_cst44____git = _i("##write-string");

_cst45____git = new _ScmString(_z("cScXcOcO"));

_cst46____git = new _ScmString(_z("cRcUcLcJcLcQ"));

_cst47____git = new _ScmString(_z("cVcWcDcWcXcV"));

_cst48____git = new _ScmString(_z("cWcDcJ"));
...
_b = _X(_cst37____git,_X(_b,null));
if (_a instanceof _Structure && _a.a[0].a[1] === _cst17____git) {
...
_s[_t-4] = _X(_cst41____git,_X(_s[_t-4],_X(_s[_t-2],null)));
_c = _s[_t];
_a = _s[_t-1];
_b = !1;
_r = _s[_t-3];
...
_b = _X(_cst45____git,_X(_cst46____git,null));
_s[_t+1] = _s[_t];
_s[_t] = _b;
_c = _a;
_b = _s[_t+1];
